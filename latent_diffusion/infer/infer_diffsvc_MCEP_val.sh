...
python infer.py --outdir outputs/diffsvc_MCEP_val --steps 50 --dataset Opencpop --checkpoint logs/diffsvc_MCEP/checkpoints/best.ckpt --config configs/infer/diffsvc_MCEP.yaml --ratio 0.5
