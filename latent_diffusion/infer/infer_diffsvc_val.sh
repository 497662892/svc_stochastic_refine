...
python infer.py --outdir outputs/diffsvc_val --steps 50 --dataset Opencpop --checkpoint logs/diffsvc/checkpoints/best.ckpt --config configs/infer/diffsvc.yaml --ratio 0.5
