...
python infer.py --outdir outputs/diffsvc_x0 --steps 50 --dataset M4Singer --checkpoint logs/diffsvc_x0/checkpoints/best.ckpt --config configs/infer/diffsvc_x0.yaml --ratio 0.5
