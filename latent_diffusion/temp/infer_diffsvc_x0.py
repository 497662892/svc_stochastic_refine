...
if __name__ == "__main__":
    ...
    config = OmegaConf.load("configs/infer/diffsvc_x0.yaml")
    model = instantiate_from_config(config.model)

    model.load_state_dict(torch.load("logs/diffsvc_x0/checkpoints/best.ckpt")["state_dict"],
                          strict=False)
